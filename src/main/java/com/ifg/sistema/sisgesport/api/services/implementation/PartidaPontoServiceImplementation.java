...
private static final Logger log = LoggerFactory.getLogger(AlunoServiceImplementation.class);
	...
	public Optional<PartidaPonto> BuscarPorId(Long id) {
		log.info("Buscando Partida Ponto pelo id {} ", id);
		return Optional.ofNullable(partidaPontoRepositorio.findOne(id));
	}

	public Optional<List<PartidaPonto>> BuscarPorJogadorId(Long id_jogador) {
	...
	public Optional<List<PartidaPonto>> BuscarPorPartidaId(Long id_partida) {
	...
	public Optional<List<PartidaPonto>> BuscarPorTipoPontoId(Long id_tipo_ponto) {
	...
	public PartidaPonto Salvar(PartidaPonto partida_ponto) {
