...
private static final Logger log = LoggerFactory.getLogger(AlunoServiceImplementation.class);
	...
	public Page<Posicao> BuscarTodosPaginavel(PageRequest pageRequest) {
		log.info("Buscando uma lista paginada de Posicao");
		return posicaoRepositorio.findAll(pageRequest);
	}
    public Optional<List<Posicao>> BuscarTodos() {
        log.info("Buscando uma lista de Tipo Ponto");
        return Optional.ofNullable(posicaoRepositorio.findAll());
    }
